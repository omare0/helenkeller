...
/*
    ...
    $("#sun").attr("src", "assets/img/home/sun.png");
    $("#globe").attr("src", "assets/img/home/globe.png");
    $("#cloud").attr("src", "assets/img/home/clouds.png");
...
*/
  ...
  /*
    ...
    $("#sun").attr("src", "assets/img/home/sun.png");
    $("#globe").attr("src", "");
    $("#cloud").attr("src", "assets/img/home/clouds_1.png");
    $("#overlay_slider_land").addClass('slider_footer_v1').removeClass('slider_footer_v2 slider_footer_v3 slider_footer_v4');
  */
  ...
  /*
    ...
    $("#sun").attr("src", "assets/img/home/sun.png");
    $("#globe").attr("src", "");
    $("#cloud").attr("src", "assets/img/home/clouds_2.png");
    $("#overlay_slider_land").addClass('slider_footer_v1').removeClass('slider_footer_v2 slider_footer_v3 slider_footer_v4');
  */
  ...
  /*
    $("#slider").css('background-color', '#94d8ff');
    $("#sun").attr("src", "assets/img/home/sun_v2.png");
    $("#globe").attr("src", "");
    $("#cloud").attr("src", "assets/img/home/clouds_5.png")
    $("#overlay_slider_land").addClass('slider_footer_v1').removeClass('slider_footer_v2 slider_footer_v3 slider_footer_v4');
  */
  ...
  /*
    ...
    $("#sun").attr("src", "assets/img/home/sun_without.png");
    $("#globe").attr("src", "");
    $("#cloud").attr("src", "assets/img/home/clouds_3.png")
    $("#overlay_slider_land").addClass('slider_footer_v1').removeClass('slider_footer_v2 slider_footer_v3 slider_footer_v4');
  */
  ...
  */
  ...
  /*
    ...
    $("#sun").attr("src", "assets/img/home/sun_without.png");
    $("#globe").attr("src", "");
    $("#cloud").attr("src", "assets/img/home/clouds_4.png")
    $("#overlay_slider_land").addClass('slider_footer_v4').removeClass('slider_footer_v1 slider_footer_v2 slider_footer_v3');
  */
...
function initMap() {
  var map = new google.maps.Map(document.getElementById('map'), {
    zoom: 16,
    center: {lat: 19.647160, lng: -99.199717},
    scrollwheel: false,
  ...
  marker = new google.maps.Marker({
    ...
    position: {lat: 19.647160, lng: -99.199717},
    icon: marker_home
  });
